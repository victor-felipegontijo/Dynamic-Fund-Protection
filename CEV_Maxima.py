...
def Laplace_Transform_G(y, x_0, s, b, a, beta):
    return psi(s, x_0, b, a, beta)/(s*psi(s, y, b, a, beta))
...
def G(y, x_0, tau, b, a, beta):
    return float(invertlaplace(lambda s: Laplace_Transform_G(y, x_0, s, b, a, beta), tau, method = 'dehoog', dps = 10))

# Integral of G w.r.t to y
def Integral_G (x_0, tau, b, a, beta, liminf, limsup):
    
    funct = lambda y: G(y, x_0, tau, b, a, beta)
    return integrate.quad(funct, liminf, limsup)[0]
